...
export const metadata: Metadata = {
  title: "용도별 노트북 추천 - 학생·개발·영상편집·게이밍·사무용",
  description:
    "대학생 노트북 추천, 개발용 코딩 노트북, 영상편집 노트북, 게이밍 노트북, 사무용 노트북, 디자인 노트북, 출장용 초경량 노트북까지 용도별 최적의 가성비 노트북을 찾아보세요. 중고·리퍼 노트북 가격 비교 제공.",
  keywords: [
    "노트북 추천", "용도별 노트북", "대학생 노트북 추천", "학생용 노트북",
    "개발용 노트북", "코딩 노트북", "영상편집 노트북", "게이밍 노트북 추천",
    "사무용 노트북 추천", "디자인 노트북", "출장용 노트북", "가성비 노트북",
    "인강용 노트북", "재택근무 노트북", "유튜버 노트북",
  ],
  alternates: {
    canonical: "/use-case",
  },
